...
public class UsuarioController {
  ...
  /** metodo que ira salvar o usuario caso ele tenha digitado todos os campos pedidos corretamente 
   * @author elizangela
   * @return usuario/cadastro */
  /** havendo também em seguida a parte da criptografia da senha digitada pelo usuario */
  @PostMapping("/salvar")
